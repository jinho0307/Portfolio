...
<div id="boardMenu">
	<ul id="innerMenu">
		<li><a href="/bgm/acashhistory">전체 Cash 사용내역</a></li>
	</ul>
</div>
<div id="nSearchContainer">
<form action="/bgm/acashhistory" method="post">
<a href="/bgm/acashhistory">전체목록</a>
...
<span>
<a href="/bgm/acashhistory?seachItem=1month">1개월</a>&nbsp;
<a href="/bgm/acashhistory?seachItem=6month">6개월</a>&nbsp;
<a href="/bgm/acashhistory?seachItem=1year">1년</a>&nbsp;
...
<div id="listDiv">
	<table align="center" id="nlistTable">
		...
		<td align="center">정보 없음</td>
		<%}else{ %>
		<td align="center"><a href="/bgm/payview?comNo=<%=n.getCompany_no()%>&userId=<%=n.getUserId() %>"> <%=n.getCompany_no()%></a></td>
		<%} %>
