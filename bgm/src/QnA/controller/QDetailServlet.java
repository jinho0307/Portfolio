...
/**
 * Servlet implementation class QDetailServlet
 */
@WebServlet("/qdetail")
public class QDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QDetailServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (q != null) {
			view = request.getRequestDispatcher("QnA/view/qAnswer.jsp");
