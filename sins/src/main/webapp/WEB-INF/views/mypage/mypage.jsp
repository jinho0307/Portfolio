        	...
        	$.ajax({
				...
				,success : function(list2) {
					...
					for(var i = 0; i < list2.commentList.length; i ++) {
						...
						if(check == 0){
							thisdiv.append('<div class="commentOne"><hr><table><tr><td><img src="/sins/resources/file/'+list.comentList[i].userid+'/'+list.commentList[i].userprofile+'" style="width: 30px; height: 30px;"></td><td><h5><table><tr><td>'+list2.commentList[i].username+'<td></tr><tr><td>'+list2.commentList[i].commentdate+'</td></tr></table></h5></td></tr></table><br></div>');
...
<body>
	...
	<div class="updateWindow window">
		<form action="mypageUpdate.b" method="post"
	...
	<div id="container">
		<div id="left" class="box">
			...
			<br/>
				<center>
				<img src="${pageContext.request.contextPath}/resources/file/${memberUser.userId}/${memberUser.userProfile}"
			...
			<ul>
				...
				<li><a href="alink.do?path=member/myInfoCheck">내 정보 보기</a></li>
			</ul>
			...
			<c:forEach var="item" items="${mylist}">
						...
						<div class="buttonContainer">
							<table>
								...
								<tr>
									...
									<!-- 원석부분 -->
									<c:if test="${item.createid ne loginUser.userId}" >
										...
										<td><input type="hidden" name="firNo" value="${item.writeno }" /></td>
									</c:if>
									<!-- 여기까지 원석부분 -->
				...
				<form id="mypageform3"action="" class="commentForm" method="post" enctype="multipart/form-data">
					<div class="score_textarea" >
						...
						<input type="hidden" value="${item.writeno }" name="contentno" class="contentno">
