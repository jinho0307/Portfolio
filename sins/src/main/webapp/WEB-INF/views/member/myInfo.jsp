	...
	<div id="container">
		<div id="left" class="box">
			...
			<img src="${pageContext.request.contextPath}/resources/file/${loginUser.userId}/${loginUser.userProfile}"
					style="width: 120px; margin: 20px 40px;"><br/>
			<input type="button" onclick="prodivshow()" value="프로필수정" style="margin-left :60px;"/>
			<script type="text/javascript">
			function prodivshow(){
				$('#profilechange').show();
			}
			...
			<div id="profilechange" style="width:200px; height: 60px; border: 1px solid black; background: white; display: none;">
				<form action="changmyprofile.j" enctype="multipart/form-data" method="post">
				<input type="file" name="file"/>
				<br/>
				<input type="button" onclick="prodivhide()" value="취소"/>
