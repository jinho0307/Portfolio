...
<script>
	...
	function fn_imageUp5() {
	 ...
	 function fn_confirm(){
		 ...
		 var fd = new FormData();
		 fd.append("filedata", $("input[name=filedata]")[0].files[0]);
		
		$.ajax({
			type: "POST",
			
			url : '${pageContext.request.contextPath}/tempUp.n',
			...
			success : function(result) {
				...
				if(result.error!=null){
					...
					window.opener.pasteHTML(result.fileName);
...
<div id="pop_wrap">
    ...
    <div id="pop_container" class="pop_container" >
		...
		<form id="editor_upimage5" name="editor_upimage5"  method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
			<input type="file" class="upload" id="filedata" name="filedata">
	    ...
	    <div class="btn_area">
            ...
            <a href="javascript:fn_cancel();"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
        <!-- //content -->
    </div>
